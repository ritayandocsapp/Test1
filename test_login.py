...
post_data = {'phonenumber': '9051210919',
             #'otp': '2029',
             'platform': 'wcjncwnjwcwcwcwcwcwcwcwcwcwcwc',
...
if results['success'] == 1 & results['data']['id']!= None:
   print('TestCase Passed and Login is successful')
